...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="DISM &amp; SFC Repair Tool v2" Height="500" Width="700"
...
$txtOutput.Text = @"
=======================================================================
  DISM & SFC Repair Tool v2 - Smart Sequence Edition
=======================================================================
...
NEW IN V2: The "Run All (Smart)" button will automatically skip
the RestoreHealth step if ScanHealth finds no corruption, saving
you time when your component store is healthy.
